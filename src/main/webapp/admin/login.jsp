...
boolean ch = UserDAO.adminLogin(username, password);
if(ch){
...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <link rel="stylesheet" href="/TruyenMa/admin/assets/css/tailwind.output.css" />
    <script
      src="https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.x.x/dist/alpine.min.js"
      defer
    ></script>
    <script src="/TruyenMa/admin/assets/js/init-alpine.js"></script>
  </head>
  <body>
        ...
        <form class="flex flex-col overflow-y-auto md:flex-row" method="post">
          <div class="h-32 md:h-auto md:w-1/2">
            <img
              ...
              src="/TruyenMa/admin/assets/img/login-office.jpeg"
              alt="Office"
            />
            <img
              aria-hidden="true"
              class="hidden object-cover w-full h-full dark:block"
              src="/TruyenMa/admin/assets/img/login-office-dark.jpeg"
              alt="Office"
            />
          </div>
