...
<div class="flex flex-col flex-1 w-full">
	...
	List<Seripart> list = SeripartDAO.getPartBySeri(idseri);
                    ...
                    <table class="w-full whitespace-no-wrap">
                        <thead>
                            <tr
                                ...
                                <th class="px-4 py-3">Phần</th>
                                <th class="px-4 py-3">Sơ lược</th>
                                    ...
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <a class = "px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100"
                                                href="editPart.jsp?idseripart=${post.getIdseripart() }">Sửa</a>
                                            |
                                            <a class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:text-red-100 dark:bg-red-700"
                                                href="adminAction/deletePart.jsp?idseripart=${post.getIdseripart() }&idseri=<%=idseri%>">Xoá</a>
                                        </td>
                                    </tr>
								</c:forEach>
                    ...
                    <span class="flex col-span-4 mt-2 sm:mt-auto sm:justify-end">
                        <nav aria-label="Table navigation">
                            <ul class="inline-flex items-center">
                                ...
                                <li>
                                    <a	href="http://localhost:8080/TruyenMa/admin/addPart.jsp?idseri=<%=idseri %>"
