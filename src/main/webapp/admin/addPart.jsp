...
<div class="flex flex-col flex-1 w-full">
	...
	Seri sr = SeriDAO.getSeriById(idseri);
	%>
    <main class="h-full pb-16 overflow-y-auto">
            <div class="container px-6 mx-auto grid">
                ...
                <h4 class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300">
                    <h5>Thêm phần tiếp theo của:</h5> <strong> --><%=sr.getTitle() %></strong> 
                </h4>
                <form method="POST"  action="adminAction/addPart.jsp" >
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
							<input type="text"  name="idseri" value="<%=idseri%>" hidden>
							<input type="text"  name="indexpart" value="<%=SeriDAO.makeNewPart(idseri)%>" hidden>
							
                        <label class="block text-sm">
                            <span class="text-gray-700 dark:text-gray-400">Tóm lược</span>
                            <input
                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                name="description"  />
                        </label>
						<label class="block text-sm">
                            <span class="text-gray-700 dark:text-gray-400">Nội dung của phần</span>
      						 <textarea id="content" style="min-height:700px" name="content" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"></textarea>
                        </label>
